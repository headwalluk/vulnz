      ...
      u.define('select2/results', ['jquery', './utils'], function (d, p) {
        ...
        return (
          ...
          (s.prototype.option = function (e) {
            ...
            e.children &&
              ((s.role = 'group'), (s['aria-label'] = e.text), t.classList.remove('select2-results__option--selectable'), t.classList.add('select2-results__option--group')),
            s)) {
              var r = s[n];
              t.setAttribute(n, r);
            }
              ...
              d.fn.mousewheel &&
                this.$results.on('mousewheel', function (e) {
                  ...
                  t
                    ...
                    : n && (i.$results.scrollTop(i.$results.get(0).scrollHeight - i.$results.height()), e.preventDefault(), e.stopPropagation());
                }),
          ...
          (e.prototype.bind = function (e, t, n) {
            ...
            (e.call(this, t, n),
              t.on('*', function (e, t) {
                var n;
                -1 !== i.indexOf(e) &&
                  ((t = t || {}), (n = o.Event('select2:' + e, { params: t })), s.$element.trigger(n), -1 !== r.indexOf(e) && (t.prevented = n.isDefaultPrevented()));
              }));
          }),
          e
        );
            ...
            (e.call(this, t, n),
              ...
              t.on('results:all', function (e) {
                (null != e.query.term && '' !== e.query.term) ||
                  (s.showSearch(e) ? s.$searchContainer[0].classList.remove('select2-search--hide') : s.$searchContainer[0].classList.add('select2-search--hide'));
              }),
              t.on('results:focus', function (e) {
                e.data._resultId ? s.$search.attr('aria-activedescendant', e.data._resultId) : s.$search.removeAttr('aria-activedescendant');
              }));
      ...
      u.define('select2/dropdown/infiniteScroll', ['jquery'], function (n) {
        ...
        return (
          ...
          (e.prototype.loadMoreIfNeeded = function () {
            ...
            !this.loading &&
              e &&
              ((e = this.$results.offset().top + this.$results.outerHeight(!1)), this.$loadingMore.offset().top + this.$loadingMore.outerHeight(!1) <= e + 50 && this.loadMore());
          }),
                  ...
                  try {
                    ...
                    try {
                      ...
                      t &&
                        window.console &&
                        console.warn &&
                        console.warn('Select2: The language file for "' + r + '" could not be automatically loaded. A fallback will be used instead.');
                    }
                  }
      ...
      u.define('select2/core', ['jquery', './options', './utils', './keys'], function (t, i, r, s) {
        ...
        return (
          ...
          (o.prototype._generateId = function (e) {
            return (
              'select2-' +
              (null != e.attr('id') ? e.attr('id') : null != e.attr('name') ? e.attr('name') + '-' + r.generateChars(2) : r.generateChars(4)).replace(/(:|\.|\[|\]|,)/g, '')
            );
          }),
